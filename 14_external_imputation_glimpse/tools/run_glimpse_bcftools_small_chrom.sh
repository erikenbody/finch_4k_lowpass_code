...
do
  ...
  $GLIMPSE_DIR/phase/bin/GLIMPSE_phase --main 15 --map $MAP_DIR/${SUBSET}_parv.gmap --input ${VCF} --reference ${REF} --input-region ${IRG} --output-region ${ORG} --output ${OUT} --thread 5
